...
import 'package:rickyandmorty/models/info_model.dart';
...
class EpisodesModel {
  ...
  factory EpisodesModel.fromMap(Map<String, dynamic> map) {
    return EpisodesModel(
      ...
      episodes: List<EpisodeModel>.from((map['results'] as List).map<EpisodeModel>((x) => EpisodeModel.fromMap(x as Map<String,dynamic>),),),
    );
  }
